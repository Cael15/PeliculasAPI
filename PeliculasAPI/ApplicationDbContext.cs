...
namespace PeliculasAPI
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        {
            var rolAdminId = "7339c700-7bb0-4ad7-bc58-7dd56a755b47";
            var usuarioAdminId = "9159ac56-dfca-4618-97b9-0333b2948561";
            ...
            var username = "ddaniel@gmail.com";
            ...
            modelBuilder.Entity<SalaDeCine>()
               .HasData(new List<SalaDeCine>
               {
                    ...
                    new SalaDeCine{Id = 4, Nombre = "Cinepolis", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-77.05783599633473, -12.006314253536946))},
                    new SalaDeCine{Id = 5, Nombre = "Cinemark", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-76.97546075459518, -12.08519776317504))},
