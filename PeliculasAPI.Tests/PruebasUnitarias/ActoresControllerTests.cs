...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class ActoresControllerTests: BasePruebas
    {
        ...
        public async Task ObtenerPersonasPaginadas()
        {
            ...
            contexto.Actores.Add(new() { Nombre = "Actor 1" });
            contexto.Actores.Add(new() { Nombre = "Actor 2" });
            contexto.Actores.Add(new() { Nombre = "Actor 3" });
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActorCreacionDTO() { Nombre = "Daniel", FechaNacimiento = DateTime.Now };
        ...
        public async Task CrearActorConFoto()
        {
            ...
            var archivo = new FormFile(new MemoryStream(content), 0, content.Length, "Data", "image.jpg");
        ...
        public async Task PatchRetorna404SiActorNoExiste()
        {
            ...
            var controler = new ActoresController(contexto, mapper, null);
            var patchDoc = new JsonPatchDocument<ActorPatchDTO>();
            var respuesta = await controler.Patch(1, patchDoc);
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            var actor = new Actor() { Nombre = "Daniel", FechaNacimiento = fechaNacimiento };
            contexto.Add(actor);
            await contexto.SaveChangesAsync();
